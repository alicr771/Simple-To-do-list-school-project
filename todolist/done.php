        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Finished Task</h1>
                        <div class="row">
                        <div class="container">
...
<!-- page -->
    ...
    $sql = "SELECT * FROM done order by id asc limit $posisi,$batas";
...
$query2     = mysqli_query($db, "SELECT * FROM done");
...
<ul class="pagination">
        ...
        for($i=1;$i<=$jmlhalaman;$i++) {
            if ($i != $halaman) {
                echo "<li class='page-item'><a class='page-link' href='done.php?halaman=$i'>$i</a></li>";
            } else {
