...
<!-- page -->
    ...
    $sql = "SELECT * FROM overdue order by id asc limit $posisi,$batas";
...
$query2     = mysqli_query($db, "SELECT * FROM overdue");
...
<ul class="pagination">
        ...
        for($i=1;$i<=$jmlhalaman;$i++) {
            if ($i != $halaman) {
                echo "<li class='page-item'><a class='page-link' href='overdue.php?halaman=$i'>$i</a></li>";
            } else {
